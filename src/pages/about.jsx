...
const AboutPage = () => {
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 300" class="fill-base-100 dark:fill-[#1d232a]">
    <path d="M0,288L40,256C80,224,160,160,240,138.7C320,117,400,139,480,128C560,117,640,75,720,96C800,117,880,203,960,229.3C1040,256,1120,224,1200,192C1280,160,1360,128,1400,112L1440,96L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
  </svg>
</div>
